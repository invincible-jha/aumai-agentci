...
### Setup
```bash
git clone https://github.com/aumai/aumai-agentci.git
cd aumai-agentci
python -m venv .venv
...
### Good First Issues
New to the project? Start with issues labeled [`good first issue`](https://github.com/aumai/aumai-agentci/labels/good%20first%20issue).
...
- [GitHub Discussions](https://github.com/aumai/aumai-agentci/discussions)
